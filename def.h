...
typedef struct {
    ...
    ReactionField **eqm_k_field,**_sec_conc_old_field,**initial_ref_field, **_mass_frac_old_field;
	PhysicalField **xold;
} UserCtx;
...
PetscErrorCode PorousFlowAqueousPreDisChemistry_computeQpReactionRates(
    ...
    ReactionField* _sec_conc_old, ReactionField* _sec_conc,
...
void PorousFlowMassFractionAqueousEquilibriumChemistry_computeQpSecondaryConcentrations(
    ReactionField* _sec_conc, ReactionField* _equilibrium_constants,
