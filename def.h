...
PetscErrorCode PorousFlowAqueousPreDisChemistry_computeQpReactionRates(
    ...
    SecondaryReactionField* _sec_conc_old, bool _equilibrium_constants_as_log10,
    void* ptr, ReactionField* initial_ref);
void PorousFlowAqueousPreDisMineral_computeQpProperties(
    double _saturation, SecondaryReactionField* _sec_conc_old,
    SecondaryReactionField* _sec_conc, ReactionField* _reaction_rate,
    PetscScalar _porosity_old, void* ptr);
...
void PorousFlowMassFractionAqueousEquilibriumChemistry_computeQpSecondaryConcentrations(
    ...
    SecondaryReactionField* _equilibrium_constants, PhysicalField* x,
    bool _equilibrium_constants_as_log10, double tsize);
...
void PorousFlowMassFractionAqueousEquilibriumChemistry_computeQpProperties(
    SecondaryReactionField* _sec_conc,
    SecondaryReactionField* _equilibrium_constants, ReactionField* _mass_frac,
    PhysicalField* x, bool _equilibrium_constants_as_log10, void* ptr,
    double tsize);
...
#if EXAMPLE == 2
void KineticDisPreRateAux_All(
    const PhysicalField* _vals,
